...
public class DefaultIniceStringTrigger extends AbstractTrigger
{
        ...
        throws TriggerException
    {
            ...
            PayloadInterfaceRegistry.I_TRIGGER_REQUEST_PAYLOAD) 
        {
            ...
            IPayload earliestPayload = new DummyPayload(earliestTime.
        ...
        // check if source is a stringhub and see if the type matches the 
        // configured type
             ...
             (type == stringTriggerType)) 
        {
            ...
            //  2) create new trigger request for inice, containing the 
            //  string trigger
            //  3) report it
