...
public class PeriodicReadoutTrigger extends AbstractTrigger
{
    ...
    //    LogFactory.getLog(PeriodicReadoutTrigger.class);
    ...
    public void addParameter(String name, String value)
        throws UnknownParameterException, IllegalParameterValueException
               {
                   if (name.equals("prescale_delta_t"))
		   {
                       if(Long.parseLong(value)>=0)
		       {
                           prescale_delta_t= Long.parseLong(value)*1000000000L; // parameter is configured in seconds....
                       ...
                       else
		       {
                   ...
                   else if (name.equals("readout_length"))
		   {
                       if(Long.parseLong(value)>=0)
		       {
                           readout_length = Long.parseLong(value); // readout_length is configued in nanoseconds....
